...
IL_022b:
	{
		...
		NullCheck(L_79);
		VirtualActionInvoker1< bool >::Invoke(9, L_79, ((*(bool*)((bool*)(bool*)UnBox(L_81, Boolean_t09A6377A54BE2F9E6985A8149F19234FD7DDFE22_il2cpp_TypeInfo_var)))));
		return;
	}
...
IL_02c8:
	{
		...
		int64_t L_99 = V_15;
		NullCheck(L_98);
		VirtualActionInvoker1< int64_t >::Invoke(21, L_98, L_99);
		return;
	}
...
IL_02d6:
	{
		...
		NullCheck(L_104);
		NullCheck(L_103);
		VirtualActionInvoker1< int32_t >::Invoke(19, L_103, ((int32_t)(((RuntimeArray*)L_104)->max_length)));
		...
		NullCheck(L_105);
		VirtualActionInvoker1< uint8_t >::Invoke(10, L_105, L_107);
		...
		NullCheck(L_108);
		VirtualActionInvoker1< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(12, L_108, L_109);
		return;
	}
...
IL_031b:
	{
		...
		NullCheck(L_112);
		VirtualActionInvoker1< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(12, L_112, L_113);
		return;
	}
